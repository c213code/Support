...
const HELP_TEXT = [
  ...
  "/delete — показать последние сообщения бота с кнопкой удаления; /delete <ссылка> — удалить конкретное (только первые 48 часов)",
  "",
...
const AGENT_COMMANDS = [
  ...
  { command: "delete", description: "Удалить сообщение бота" },
