...
- Агент ПРОСИТ ПРОВЕРИТЬ результат ("тексеріп көресіз бе", "кіріп көріңізші", "қазір шығу керек", "енді кіріп тұр", "проверьте", "должно открываться") — значит, он УЖЕ сделал исправление и просит куратора убедиться. Это результат, а не SKIP: назови сделанное по обращению ("Сабақтар ашылды", "Оқу басталу уақыты өзгертілді"). Никогда не пиши "Тексерілді" — проверял не агент, он просит проверить.
