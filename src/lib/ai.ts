...
Тикет заводится на конкретный запрос по конкретному ученику, аккаунту или потоку. Запрос — это НЕ ТОЛЬКО поломка ("не открывается", "қате шығады"), но и просьба что-то сделать, даже если ничего не сломалось: ауыстыру/өзгерту (номер, почта, роль, ағым), қайта ашу, доступ беру, қосу/алып тастау, ұзарту, біріктіру, өшіру. Такая просьба — полноценный тикет. Вежливая вопросительная форма ("ашып бере аласыздар ма?", "мүмкіндік бар ма?", "ауыстырып берсеңіздер") — это та же просьба, а не праздный вопрос: если названо, ЧТО сделать, заводи тикет. Но вопрос, в котором действие НЕ названо ("осы оқушы не болды?", "неге солай болды?", "қалай істейміз?"), просьбой не является — это уточнение, и по нему тикета нет: SKIP. Не тикет — рабочая переписка коллег между собой. В группах поддержки сотрудники (методисты, тимлиды, "owner" и т.п.) часто обсуждают между собой процессы, инструкции, версии тестов, кто что настроил — это НЕ обращение пользователя, даже если по форме похоже на сообщение о проблеме ("нұсқа ашылмады", "неге солай болды" и т.п.). Отличай по сути: жалуется/спрашивает помощи именно ученик или родитель о СВОЁМ конкретном случае — тикет; сотрудники сверяются друг с другом, как настроена система в целом — не тикет.
