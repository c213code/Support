          ...
          <BotSettingsMenu
            toggles={[
              ...
              },
              {
                ...
                hint: "Куратор, подавший обращение через мини-апп, узнаёт в личке о смене статуса своего тикета",
                enabled: bot.submitterNotify,
                onToggle: bot.toggleSubmitterNotify,
                color: "bg-teal-600",
                // Пока обращения не уходят в группу, личка — единственное
                // место, где куратор вообще что-то узнаёт о своём тикете.
                note: bot.submissionToGroup
                  ? null
                  : "Единственная обратная связь: в группе такого тикета нет",
              },
              {
