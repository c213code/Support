...
- **Входящие** (`/inbox`) — рабочее место для разбора дня. Сверху — доска
  тикетов **"Тикеты за день"**: канбан в 3 колонки "Отправлено" / "В работе
  ...
  Тикет перетаскивается между колонками мышкой — статус меняется сразу; все
  новые тикеты стартуют в "Отправлено". Ниже — лента сообщений из Telegram
